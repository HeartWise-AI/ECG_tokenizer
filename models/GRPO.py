...
class Training:
    ...
    def __init__(self, reward_model, 
        ...
        if model == None:
            model = ECG_Gemma3forConditionalGeneration()
        ...
        if text_tokenizer == None:
            text_tokenizer = AutoTokenizer.from_pretrained("google/gemma-7b")
        
        self.text_tokenizer = text_tokenizer
    
    def train_adapters(self, dataloader, num_epochs = 3):

        #Example batch
        #Batch 
        #{"input_ids": torch.LongTensor of shape (batch_size, seq_len),
        #"ecg_signals": torch.FloatTensor of shape (batch_size, leads, ecg_seq_len),
        ...
        for epoch in range(num_epochs):
            ...
            for batch in dataloader:
                ...
                ecg_signals = batch["ecg_signals"].to(self.device)
    ...
    def grpo(self, dataloader, adapter_path, epochs = 4, max_new_tokens = 128, num_candidates = 4):
        ...
        for epoch in range(epochs):
            ...
            for batch in dataloader:
                ...
                scores = self.reward_model(outputs_for_batch)
                ...
                for i, candidate in enumerate(outputs_for_batch):
                    ...
                    with torch.no_grad():
                        ...
                        output = adapter_model(input_ids = input_ids_c,
                                                ...
                                                ecg_signals = ecg_signals[i // num_candidates].unsqueeze(0))
