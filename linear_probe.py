...
def train(classifier, train_loader, val_loader, optimizer, criterion, num_epochs, labels, scheduler, checkpoint_path):
    ...
    for epoch in pbar:
        ...
        wandb.log({'val/Conduction Disorder': val_metrics['Conduction Disorder']})
        wandb.log({'val/Enlargement of the heart chambers': val_metrics['Enlargement of the heart chambers']})
