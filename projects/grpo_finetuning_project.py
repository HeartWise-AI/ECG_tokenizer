...
class GRPOFinetuningProject(BaseProject):
    ...
    def _setup_validation_objects(self) -> dict[str, Any]:
        raise NotImplementedError("GRPO validation not implemented.")

    def _setup_test_objects(self) -> dict[str, Any]:
        raise NotImplementedError("GRPO testing not implemented.")
