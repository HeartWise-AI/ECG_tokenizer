...
class RLFinetuningProjectBase(BaseProject):
    ...
    def _load_model_from_checkpoint(self, checkpoint_path: str):
        ...
        model = ECG_Tokenizer_Wrapper(
            ...
            bridge_mix_strategy=_cfg_get(yaml_config, "bridge_mix_strategy", _cfg_get(pretrained_config, "bridge_mix_strategy", None)),
            bridge_token_axis=_cfg_get(yaml_config, "bridge_token_axis", _cfg_get(pretrained_config, "bridge_token_axis", None)),
