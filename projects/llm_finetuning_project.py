...
class LLMFinetuningProject(BaseProject):
    ...
    def _setup_training_objects(self)->dict[str, Any]: 
        ...
        ecg_tokenizer: ECG_Tokenizer_Wrapper = ModelRegistry.get(self.config.model_name)(
            ...
            bridge_mix_strategy=getattr(self.config, 'bridge_mix_strategy', None),
            bridge_token_axis=getattr(self.config, 'bridge_token_axis', None),
    ...
    def _setup_inference_objects(self)->dict[str, Any]:
        ...
        ecg_tokenizer: ECG_Tokenizer_Wrapper = ModelRegistry.get(self.config.pipeline_project)(
            ...
            bridge_mix_strategy=getattr(pretrained_config, 'bridge_mix_strategy', getattr(self.config, 'bridge_mix_strategy', None)),
            bridge_token_axis=getattr(pretrained_config, 'bridge_token_axis', getattr(self.config, 'bridge_token_axis', None)),
